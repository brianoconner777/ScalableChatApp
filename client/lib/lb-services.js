...
/**
 * @ngdoc object
 * @name lbServices.Fixtures
 * @header lbServices.Fixtures
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Fixtures` model.
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/fixtures/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Fixtures#setupFixtures
             * @methodOf lbServices.Fixtures
             *
             * @description
             *
             * Setup fixtures
             ...
             */
            "setupFixtures": {
              url: urlBase + "/fixtures/setup",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Fixtures#teardownFixtures
             * @methodOf lbServices.Fixtures
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Fixtures#modelName
        * @propertyOf lbServices.Fixtures
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Fixtures`.
        */
        R.modelName = "Fixtures";
